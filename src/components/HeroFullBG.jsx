...
export default function HeroFullBG() {
    ...
    <section className="bg-neutral-800">
        <div className="relative isolate overflow-hidden">
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 px-6 lg:px-0 lg:max-w-4xl">
                <div className="text-center">
                    <h1 className="mt-10 font-bold tracking-tight text-white text-4xl md:text-5xl lg:text-6xl">{headingText}</h1>
