export default function USP(props) {
    const { headerText, headerSubText, features } = props

    if (!headerText || !headerSubText || !features) {
        ...
        >
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-2xl font-extrabold tracking-tight text-neutral-800 md:text-3xl lg:text-4xl">
                        {headerText}
                    </h2>
                        ...
                        <div className="flex flex-col">
                            ...
                            <dt className="text-base font-semibold leading-7 text-neutral-800">
                                <div className="items-bottom justify-left mb-3 flex h-16 w-16 rounded-lg bg-transparent">
                                    <span className="h-12 w-12 text-secondary-700">
                                        <svg
