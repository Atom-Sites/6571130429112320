...
export default function Nav(props) {
    const { logoUrl, altText, services, phone } = props

    const [mobileMenuOpen, setMobileMenuOpen] = useState(false)

    return (
        <header className="sticky top-0 z-10 bg-white py-1 shadow">
            <nav
                className="mx-auto flex max-w-screen-2xl items-center justify-between lg:px-8"
                aria-label="Global"
            >
                ...
                <div className="flex lg:hidden">
                    ...
                    <div className="ml-2 flex items-center">
                        <a
                            ...
                            aria-label="Button with hidden text"
                        >
                            <svg
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Popover.Group className="j mr-4 hidden justify-end py-5 lg:flex lg:gap-x-8">
                        <Popover className="relative">
                            <Popover.Button className="focus-visible:transparent flex items-center gap-x-1 text-sm font-semibold leading-6 text-neutral-900 hover:text-primary-700 focus-visible:outline focus-visible:outline-0 focus-visible:outline-offset-2">
                                Our Services
                                <ChevronDownIcon
                                    className="hidden h-5 w-5 flex-none text-neutral-400"
                                    aria-hidden="true"
                                />
                            </Popover.Button>
